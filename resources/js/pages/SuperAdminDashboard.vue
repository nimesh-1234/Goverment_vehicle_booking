            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="booking in allBookings" :key="booking.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  ...
                  <Link :href="route('super-admin.bookings.destroy', booking.id)" method="delete" as="button" class="text-red-600 hover:text-red-900 font-semibold">Delete</Link>
                </td>
              </tr>
...
const submitBooking = () => {
  bookingForm.put(route('super-admin.bookings.update', bookingForm.id), {
